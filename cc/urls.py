...
path('complaint/<int:id>/download/', views.download_report, name='download_report'),
path('complaint/<int:id>/feedback/', views.feedback_page, name='feedback_page'),
  path('admin/complaints/charts/', views.complaints_chart, name='complaints_chart'),
]